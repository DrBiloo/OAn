...
export default async function LoginPage({ params, searchParams }: PageProps<"/[locale]/login">) {
  ...
  return <main className="min-h-screen">
    ...
    <section className="mx-auto max-w-2xl px-5 pb-16 pt-7 text-center">
      <div className="mx-auto mb-7 aspect-square w-52 overflow-hidden rounded-full border-8 border-white/75 bg-[var(--sage)] shadow-[0_20px_55px_rgba(36,49,45,0.14)]"><div className="flex h-full items-end justify-center bg-gradient-to-t from-black/25 to-transparent p-5"><span className="font-sans text-[10px] uppercase tracking-[0.25em] text-white">O♥An</span></div></div>
